...
| ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `reusable_procedure` / `procedure_steps` (deterministic-sourced `formula_or_procedure` objects) | HIGH                                                           | Replaced with structural metadata: `procedure_step_count`, `procedure_step_marker_types` (per-step marker _shape_ only — "step_n"/"numbered"/"first"/"then"/"next"/"finally"/"journal_keyword"/"algo_keyword"/"other" — never the step's own words)                                                                                              |
...
- **Stable object IDs / urn / serialization ordering:** every id, urn,
  ...
  sanitizer only pops/adds keys on the _same_ dict objects, in place,
